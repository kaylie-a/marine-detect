...
image_files = sorted(glob.glob(current_dir+"\\datasets\\Images\\FishInv\\test\\images\\*.jpg"))
label_files = sorted(glob.glob(current_dir+"\\datasets\\Images\\FishInv\\test\\labels\\*.txt"))
model = current_dir+"\\models\\!FishInv.pt"
